...
namespace WindowsCalendar
{
    ...
    {
        // 以下代码出处（有删改）：http://www.cnblogs.com/mingmingruyuedlut/archive/2011/10/14/2212255.html
        // 版权归原作者所有
        ...
        public EmailService(string server, string toMail, string fromMail,
            string subject, string emailBody, string username, string password,
            string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
